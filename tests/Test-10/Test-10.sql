...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 12 mai 2026 à 09:56
...
CREATE TABLE `f` (
  ...
  `liste_focaccia_sans_champignons` varchar(50) NOT NULL,
...
INSERT INTO `f` (`liste_focaccia_sans_champignons`) VALUES
('Américaine'),
('Hawaienne');
...
ALTER TABLE `f`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_focaccia_nom` (`liste_focaccia_sans_champignons`),
